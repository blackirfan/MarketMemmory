package com.example.marketmemmory;
...
import com.example.marketmemmory.Model.Data;
...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Daily Market List");
        ...
        mDatabase= FirebaseDatabase.getInstance().getReference().child("Market List").child(uId);
...
//                    dialog.dismiss();
    ...
    public void updateData(){
        ...
        View mView=inflater.inflate(R.layout.updated_input_field,null);
        ...
        edt_Ammoun.setInputType(InputType.TYPE_CLASS_NUMBER);
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(mAmmount)){
                    edt_Ammoun.setError("Required Field..");
                    return;
                }
                ...
                if (TextUtils.isEmpty(note)){
                    edt_Note.setError("Required Field..");
                    return;
                }
